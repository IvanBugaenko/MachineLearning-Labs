...
KNN, или же метод k-ближайших соседей, является одним из самых простых, но в то же время эффективным классификатором. Он исходит из так называемой "гипотезы компактности", которая гласит о том, что объекты одного класса находятся близко к друг другу, а объекты разных классов, навпротив, - далеко друг от друга. 
